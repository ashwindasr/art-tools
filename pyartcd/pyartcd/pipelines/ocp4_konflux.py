...
from artcommonlib.constants import KONFLUX_ART_IMAGES_PUBLIC, KONFLUX_IMAGESTREAM_OVERRIDE_VERSIONS
...
class KonfluxOcp4Pipeline:
    ...
    async def mirror_images(self):
        ...
        LOGGER.info(f'Mirroring images to {KONFLUX_ART_IMAGES_PUBLIC}...')
